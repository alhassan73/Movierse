...
export default function Searchbar() {
  return (
    <div className="w-full md:w-3/4 lg:w-1/2   flex flex-col justify-center items-center gap-7 mt-10">
      ...
      <div className="flex w-full justify-between items-center  text-lg search-container focus-within:border-[#4effba] border bg-black p-5 rounded-lg shadow-sm relative bg-transparent">
        ...
        <input
          type="text"
          placeholder=" "
          className="search-input absolute right-0 inset-y-1 border-0 outline-0 left-[10%] bg-black w-[90%]  ps-8 text-[#4effba] bg-transparent"
          id="searchInput"
        />
        <label
          htmlFor="searchInput"
